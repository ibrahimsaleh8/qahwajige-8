    ...
    <section id="about" className="py-20 px-4 bg-[#F5F5F5]">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-[0_18px_45px_rgba(15,23,42,0.08)] text-[#111827]">
            <p  className="text-white flex mb-5 bg-main-color-dark w-fit px-6 py-2.5 rounded-full text-sm md:text-base max-w-2xl shadow-sm">
                ...
                features.map((feature) => {
                  ...
                  return (
                    <li key={feature.title} className="flex items-start gap-4">
                      <div className="shrink-0 w-10 h-10 rounded-xl bg-main-color/10 flex items-center justify-center">
                        <IconComponent className="w-5 h-5 text-main-color-dark" />
                      </div>
                      <div>
